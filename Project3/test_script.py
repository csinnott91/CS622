...
data2 = helpers.generate_training_data_binary(2)
[w,b,S] = bc.svm_train_brute(data2)
print(w,b,S)

print(" ")
print("SVM Binary Classification Test 3:")
data3 = helpers.generate_training_data_binary(3)
[w,b,S] = bc.svm_train_brute(data3)
print(w,b,S)

print(" ")
print("SVM Binary Classification Test 4:")
data4 = helpers.generate_training_data_binary(4)
[w,b,S] = bc.svm_train_brute(data4)
print(w,b,S)
